...
/***********************************************************************************************/	
	...
	jQuery('#nav-principal a').on('click',function(){
...
/*	
	jQuery('#ver-mas').on('click',function(){
		jQuery('p #ver-mas').fadeOut();
		jQuery('#biography-section-full').slideDown();

	});
	
	jQuery('#ver-menos').on('click',function(){
		jQuery('p #ver-mas').fadeIn();
		jQuery('#biography-section-full').slideUp();

	});
	
	*/
	jQuery('#ver-mas').on('click',function(){
		jQuery('#biography-section').slideUp();
		jQuery('#biography-section-full').slideDown();

	});
	
	jQuery('#ver-menos').on('click',function(){
		jQuery('#biography-section').slideDown();
		jQuery('#biography-section-full').slideUp();
